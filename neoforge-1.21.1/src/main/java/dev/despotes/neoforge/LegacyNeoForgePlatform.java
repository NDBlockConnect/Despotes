...
/**
 * NeoForge platform implementation for the legacy official-mapping range
 * (Minecraft 1.21.1). Mirrors the Fabric legacy platform API shapes.
 */
public final class LegacyNeoForgePlatform implements IGamePlatform {
    ...
    public ScreenHandle screen() {
        ...
        return s == null ? null : new LegacyNeoForgeScreenHandle(s);
    }
