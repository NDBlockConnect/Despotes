...
/** Legacy NeoForge screen handle backed by the live Screen. */
public final class LegacyNeoForgeScreenHandle implements ScreenHandle {

    private final Screen screen;

    public LegacyNeoForgeScreenHandle(Screen screen) {
        this.screen = screen;
    }
