...
/** NeoForge player handle backed by the live LocalPlayer. */
public final class NeoForgePlayerHandle implements PlayerHandle {

    private final LocalPlayer player;

    public NeoForgePlayerHandle(LocalPlayer player) {
        this.player = player;
    }
