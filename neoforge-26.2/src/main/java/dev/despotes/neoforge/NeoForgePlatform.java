...
/** NeoForge (Minecraft 26.2, official mappings) implementation of the platform SPI. */
public final class NeoForgePlatform implements IGamePlatform {
    ...
    public void drawOverlay(java.util.List<String> lines) {
        // Rendering is performed by the RenderGuiEvent.Post hook; kept as no-op hook.
    }
